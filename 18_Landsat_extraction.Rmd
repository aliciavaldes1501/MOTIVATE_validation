...
ReSurvey_data <- read_csv(
  here("data", "clean", "ReSurvey_QRST_data_V2025.2_20251007.csv")) %>%
...
```{r}
data_RS_Landsat_bands <- data_RS_Landsat_bands %>%
...
```{r}
data_RS_Landsat_bands_out <- read_csv(
  "C:/Data/MOTIVATE/MOTIVATE_RS_data/Landsat_out/AllPoints_Landsat_Annual.csv",
...
```{r}
# Columns in data_RS_Landsat_bands but not in data_RS_Landsat_bands_out
setdiff(names(data_RS_Landsat_bands), names(data_RS_Landsat_bands_out))

# Columns in data_RS_Landsat_bands_out but not in data_RS_Landsat_bands
setdiff(names(data_RS_Landsat_bands_out), names(data_RS_Landsat_bands))
```

# Join all data

```{r}
data_RS_Landsat_bands <- bind_rows(data_RS_Landsat_bands, data_RS_Landsat_bands_out)
```
...
write_tsv(final_RS_data,
          here("data", "clean","final_RS_data_bands_Landsat_all_20251021.csv"))
```
