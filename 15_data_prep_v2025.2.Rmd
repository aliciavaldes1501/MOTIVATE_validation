...
```{r}
write_csv(data_V2025.2,here("data", "clean","ReSurvey_data_V2025.2_20251007.csv"))
```
...
### Convert to shapefile (better for GEE)

Using a csv might give problems in GEE.

```{r}
st_write(st_as_sf(data_V2025.2 %>% 
                    dplyr::filter(EUNISa_1 %in% c("Q", "R", "S", "T")),
                  coords = c("Lon_updated", "Lat_updated"), crs = 4326),
         here("data", "shp", "ReSurvey_QRST_data_V2025.2_20251007.shp"))
```
...
write_csv(data_V2025.2 %>% 
          ...
          here("data", "clean","ReSurvey_QRST_from2016_data_V2025.2_20251007.csv"))
```
...
st_write(st_as_sf(data_V2025.2 %>% 
                    ...
                    dplyr::filter(year >= 2016),
                  coords = c("Lon_updated", "Lat_updated"), crs = 4326),
         here("data", "shp", "ReSurvey_QRST_from2016_data_V2025.2_20251007.shp"))
```
