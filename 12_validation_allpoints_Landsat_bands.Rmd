---
title: "Script to validate points in ReSurvey database using RS data (Landsat only)"
...
This R script is used to validate the points in the ReSurvey database using RS indicators (indices + phenology + canopy height). Not fiting all the models that were fit / planned for S2 data. So far, using only months method for phenology, and fitting models with GPS points after rough validation with / without training data refinement. I have commented code lines that are not used so far.
...
folder_path <- here("objects", "RF", "Landsat")
...
data_validation <- read_tsv(here(
  "data", "clean","final_RS_data_bands_Landsat_all_20250918.csv"))
```
...
## MODIFY EUNIS2 levels if needed: Function to compute ROC (level 2)
...
```{r eval=FALSE, include=FALSE}
# save(rf1, file = "objects/RF/Landsat/rf1_model_l1_slope_novalid_GPS_Landsat.Rdata")
# save(rf2, file = "objects/RF/Landsat/rf2_model_l1_slope_novalid_GPSdiff_Landsat.Rdata")
# save(rf3, file = "objects/RF/Landsat/rf3_model_l1_slope_roughvalid_GPS_Landsat.Rdata")
# save(rf4, file = "objects/RF/Landsat/rf4_model_l1_slope_roughvalid_GPSdiff_Landsat.Rdata")
# # save(rf5,
# #      file = "objects/RF/Landsat/rf5_model_l1_slope_roughvalid-refin1090_GPS_Landsat.Rdata")
# # save(rf6,
# #      file = "objects/RF/Landsat/rf6_model_l1_slope_roughvalid-refin1090_GPSdiff_Landsat.Rdata")
# # save(rf7,
# #      file = "objects/RF/Landsat/rf7_model_l1_slope_roughvalid-refin2080_GPS_Landsat.Rdata")
# # save(rf8,
# #      file = "objects/RF/Landsat/rf8_model_l1_slope_roughvalid-refin2080_GPSdiff_Landsat.Rdata")
# save(rf9, file = "objects/RF/Landsat/rf9_model_l1_treshold_novalid_GPS_Landsat.Rdata")
# save(rf10, file = "objects/RF/Landsat/rf10_model_l1_treshold_novalid_GPSdiff_Landsat.Rdata")
# save(rf11, file = "objects/RF/Landsat/rf11_model_l1_treshold_roughvalid_GPS_Landsat.Rdata")
# save(rf12, file = "objects/RF/Landsat/rf12_model_l1_treshold_roughvalid_GPSdiff_Landsat.Rdata")
# # save(rf13,
# #      file = "objects/RF/Landsat/rf13_model_l1_treshold_roughvalid-refin1090_GPS_Landsat.Rdata")
# # save(rf14,
# #      file = "objects/RF/Landsat/rf14_model_l1_treshold_roughvalid-refin1090_GPSdiff_Landsat.Rdata")
# # save(rf15,
# #      file = "objects/RF/Landsat/rf15_model_l1_treshold_roughvalid-refin2080_GPS_Landsat.Rdata")
# # save(rf16,
# #      file = "objects/RF/Landsat/rf16_model_l1_treshold_roughvalid-refin2080_GPSdiff_Landsat.Rdata")
# save(rf17, file = "objects/RF/Landsat/rf17_model_l1_months_novalid_GPS_Landsat.Rdata")
# save(rf18, file = "objects/RF/Landsat/rf18_model_l1_months_novalid_GPSdiff_Landsat.Rdata")
save(rf19, file = "objects/RF/Landsat/rf19_model_l1_months_roughvalid_GPS_Landsat.Rdata")
# save(rf20, file = "objects/RF/Landsat/rf20_model_l1_months_roughvalid_GPSdiff_Landsat.Rdata")
# # save(rf21, 
# #      file = "objects/RF/Landsat/rf21_model_l1_months_roughvalid-refin1090_GPS_Landsat.Rdata")
# # save(rf22,
# #      file = "objects/RF/Landsat/rf22_model_l1_months_roughvalid-refin1090_GPSdiff_Landsat.Rdata")
# # save(rf23,
# #      file = "objects/RF/Landsat/rf23_model_l1_months_roughvalid-refin2080_GPS_Landsat.Rdata")
# # save(rf24, 
# #      file = "objects/RF/Landsat/rf24_model_l1_months_roughvalid-refin2080_GPS_Landsat.Rdata")
```
...
```{r eval=FALSE, include=FALSE}
# save(predictions_rf1, file = "objects/RF/Landsat/rf1_pred_l1_slope_novalid_GPS_Landsat.Rdata")
# save(predictions_rf2, file = "objects/RF/Landsat/rf2_pred_l1_slope_novalid_GPSdiff_Landsat.Rdata")
# save(predictions_rf3, file = "objects/RF/Landsat/rf3_pred_l1_slope_roughvalid_GPS_Landsat.Rdata")
# save(predictions_rf4, file = "objects/RF/Landsat/rf4_pred_l1_slope_roughvalid_GPSdiff_Landsat.Rdata")
# # save(predictions_rf5,
# #      file = "objects/RF/Landsat/rf5_pred_l1_slope_roughvalid-refin1090_GPS_Landsat.Rdata")
# # save(predictions_rf6,
# #      file = "objects/RF/Landsat/rf6_pred_l1_slope_roughvalid-refin1090_GPSdiff_Landsat.Rdata")
# # save(predictions_rf7,
# #      file = "objects/RF/Landsat/rf7_pred_l1_slope_roughvalid-refin2080_GPS_Landsat.Rdata")
# # save(predictions_rf8,
# #      file = "objects/RF/Landsat/rf8_pred_l1_slope_roughvalid-refin2080_GPSdiff_Landsat.Rdata")
# save(predictions_rf9, file = "objects/RF/Landsat/rf9_pred_l1_treshold_novalid_GPS_Landsat.Rdata")
# save(predictions_rf10, file = "objects/RF/Landsat/rf10_pred_l1_treshold_novalid_GPSdiff_Landsat.Rdata")
# save(predictions_rf11, file = "objects/RF/Landsat/rf11_pred_l1_treshold_roughvalid_GPS_Landsat.Rdata")
# save(predictions_rf12, file = "objects/RF/Landsat/rf12_pred_l1_treshold_roughvalid_GPSdiff_Landsat.Rdata")
# # save(predictions_rf13,
# #      file = "objects/RF/Landsat/rf13_pred_l1_treshold_roughvalid-refin1090_GPS_Landsat.Rdata")
# # save(predictions_rf14,
# #      file = "objects/RF/Landsat/rf14_pred_l1_treshold_roughvalid-refin1090_GPSdiff_Landsat.Rdata")
# # save(predictions_rf15,
# #      file = "objects/RF/Landsat/rf15_pred_l1_treshold_roughvalid-refin2080_GPS_Landsat.Rdata")
# # save(predictions_rf16,
# #      file = "objects/RF/Landsat/rf16_pred_l1_treshold_roughvalid-refin2080_GPSdiff_Landsat.Rdata")
# save(predictions_rf17, file = "objects/RF/Landsat/rf17_pred_l1_months_novalid_GPS_Landsat.Rdata")
# save(predictions_rf18, file = "objects/RF/Landsat/rf18_pred_l1_months_novalid_GPSdiff_Landsat.Rdata")
save(predictions_rf19, file = "objects/RF/Landsat/rf19_pred_l1_months_roughvalid_GPS_Landsat.Rdata")
# save(predictions_rf20, file = "objects/RF/Landsat/rf20_pred_l1_months_roughvalid_GPSdiff_Landsat.Rdata")
# # save(predictions_rf21, 
# #      file = "objects/RF/Landsat/rf21_pred_l1_months_roughvalid-refin1090_GPS_Landsat.Rdata")
# # save(predictions_rf22,
# #      file = "objects/RF/Landsat/rf22_pred_l1_months_roughvalid-refin1090_GPSdiff_Landsat.Rdata")
# # save(predictions_rf23,
# #      file = "objects/RF/Landsat/rf23_pred_l1_months_roughvalid-refin2080_GPS_Landsat.Rdata")
# # save(predictions_rf24, 
# #      file = "objects/RF/Landsat/rf24_pred_l1_months_roughvalid-refin2080_GPS_Landsat.Rdata")
```
...
```{r eval=FALSE, include=FALSE}
# save(varimp_rf1, file = "objects/RF/Landsat/rf1_varimp_l1_slope_novalid_GPS_Landsat.Rdata")
# save(varimp_rf2, file = "objects/RF/Landsat/rf2_varimp_l1_slope_novalid_GPSdiff_Landsat.Rdata")
# save(varimp_rf3, file = "objects/RF/Landsat/rf3_varimp_l1_slope_roughvalid_GPS_Landsat.Rdata")
# save(varimp_rf4, file = "objects/RF/Landsat/rf4_varimp_l1_slope_roughvalid_GPSdiff_Landsat.Rdata")
# # save(varimp_rf5, 
# #      file = "objects/RF/Landsat/rf5_varimp_l1_slope_roughvalid-refin1090_GPS_Landsat.Rdata")
# # save(varimp_rf6, 
# #      file = "objects/RF/Landsat/rf6_varimp_l1_slope_roughvalid-refin1090_GPSdiff_Landsat.Rdata")
# # save(varimp_rf7,
# #      file = "objects/RF/Landsat/rf7_varimp_l1_slope_roughvalid-refin2080_GPS_Landsat.Rdata")
# # save(varimp_rf8, 
# #      file = "objects/RF/Landsat/rf8_varimp_l1_slope_roughvalid-refin2080_GPSdiff_Landsat.Rdata")
# save(varimp_rf9, file = "objects/RF/Landsat/rf9_varimp_l1_threshold_novalid_GPS_Landsat.Rdata")
# save(varimp_rf10, file = "objects/RF/Landsat/rf10_varimp_l1_threshold_novalid_GPSdiff_Landsat.Rdata")
# save(varimp_rf11, file = "objects/RF/Landsat/rf11_varimp_l1_threshold_roughvalid_GPS_Landsat.Rdata")
# save(varimp_rf12, file = "objects/RF/Landsat/rf12_varimp_l1_threshold_roughvalid_GPSdiff_Landsat.Rdata")
# # save(varimp_rf13, 
# #      file = "objects/RF/Landsat/rf13_varimp_l1_threshold_roughvalid-refin1090_GPS_Landsat.Rdata")
# # save(varimp_rf14, 
# #      file = "objects/RF/Landsat/rf14_varimp_l1_threshold_roughvalid-refin1090_GPSdiff_Landsat.Rdata")
# # save(varimp_rf15,
# #      file = "objects/RF/Landsat/rf15_varimp_l1_threshold_roughvalid-refin2080_GPS_Landsat.Rdata")
# # save(varimp_rf16, 
# #      file = "objects/RF/Landsat/rf16_varimp_l1_threshold_roughvalid-refin2080_GPSdiff_Landsat.Rdata")
# save(varimp_rf17, file = "objects/RF/Landsat/rf17_varimp_l1_months_novalid_GPS_Landsat.Rdata")
# save(varimp_rf18, file = "objects/RF/Landsat/rf18_varimp_l1_months_novalid_GPSdiff_Landsat.Rdata")
save(varimp_rf19, file = "objects/RF/Landsat/rf19_varimp_l1_months_roughvalid_GPS_Landsat.Rdata")
# save(varimp_rf20, file = "objects/RF/Landsat/rf20_varimp_l1_months_roughvalid_GPSdiff_Landsat.Rdata")
# # save(varimp_rf21,
# #      file = "objects/RF/Landsat/rf21_varimp_l1_months_roughvalid-refin1090_GPS_Landsat.Rdata")
# # save(varimp_rf22, 
# #      file = "objects/RF/Landsat/rf22_varimp_l1_months_roughvalid-refin1090_GPSdiff_Landsat.Rdata")
# # save(varimp_rf23, 
# #      file = "objects/RF/Landsat/rf23_varimp_l1_months_roughvalid-refin2080_GPS_Landsat.Rdata")
# # save(varimp_rf24, 
# #      file = "objects/RF/Landsat/rf24_varimp_l1_months_roughvalid-refin2080_GPSdiff_Landsat.Rdata")
```
...
#      file = "objects/RF/Landsat/rf1_varimp-cond_l1_slope_novalid_GPS_Landsat.Rdata")
# save(varimp-cond_rf2,
#      file = "objects/RF/Landsat/rf2_varimp-cond_l1_slope_novalid_GPSdiff_Landsat.Rdata")
# save(varimp-cond_rf3,
#      file = "objects/RF/Landsat/rf3_varimp-cond_l1_slope_roughvalid_GPS_Landsat.Rdata")
# save(varimp-cond_rf4,
#      file = "objects/RF/Landsat/rf4_varimp-cond_l1_slope_roughvalid_GPSdiff_Landsat.Rdata")
# # save(varimp-cond_rf5, 
# #      file = "objects/RF/Landsat/rf5_varimp-cond_l1_slope_roughvalid-refin1090_GPS_Landsat.Rdata")
# # save(varimp-cond_rf6, 
# #      file = "objects/RF/Landsat/rf6_varimp-cond_l1_slope_roughvalid-refin1090_GPSdiff_Landsat.Rdata")
# # save(varimp-cond_rf7,
# #      file = "objects/RF/Landsat/rf7_varimp-cond_l1_slope_roughvalid-refin2080_GPS_Landsat.Rdata")
# # save(varimp-cond_rf8, 
# #      file = "objects/RF/Landsat/rf8_varimp-cond_l1_slope_roughvalid-refin2080_GPSdiff_Landsat.Rdata")
# save(varimp-cond_rf9, 
#      file = "objects/RF/Landsat/rf9_varimp-cond_l1_threshold_novalid_GPS_Landsat.Rdata")
# save(varimp-cond_rf10,
#      file = "objects/RF/Landsat/rf10_varimp-cond_l1_threshold_novalid_GPSdiff_Landsat.Rdata")
# save(varimp-cond_rf11,
#      file = "objects/RF/Landsat/rf11_varimp-cond_l1_threshold_roughvalid_GPS_Landsat.Rdata")
# save(varimp-cond_rf12, 
#      file = "objects/RF/Landsat/rf12_varimp-cond_l1_threshold_roughvalid_GPSdiff_Landsat.Rdata")
# # save(varimp-cond_rf13, 
# #      file = "objects/RF/Landsat/rf13_varimp-cond_l1_threshold_roughvalid-refin1090_GPS_Landsat.Rdata")
# # save(varimp-cond_rf14, 
# #      file = "objects/RF/Landsat/rf14_varimp-cond_l1_threshold_roughvalid-refin1090_GPSdiff_Landsat.Rdata")
# # save(varimp-cond_rf15,
# #      file = "objects/RF/Landsat/rf15_varimp-cond_l1_threshold_roughvalid-refin2080_GPS_Landsat.Rdata")
# # save(varimp-cond_rf16, 
# #      file = "objects/RF/Landsat/rf16_varimp-cond_l1_threshold_roughvalid-refin2080_GPSdiff_Landsat.Rdata")
# save(varimp-cond_rf17,
#      file = "objects/RF/Landsat/rf17_varimp-cond_l1_months_novalid_GPS_Landsat.Rdata")
# save(varimp-cond_rf18, 
#      file = "objects/RF/Landsat/rf18_varimp-cond_l1_months_novalid_GPSdiff_Landsat.Rdata")
save(varimp-cond_rf19, 
     file = "objects/RF/Landsat/rf19_varimp-cond_l1_months_roughvalid_GPS_Landsat.Rdata")
# save(varimp-cond_rf20, 
#      file = "objects/RF/Landsat/rf20_varimp-cond_l1_months_roughvalid_GPSdiff_Landsat.Rdata")
# # save(varimp-cond_rf21,
# #      file = "objects/RF/Landsat/rf21_varimp-cond_l1_months_roughvalid-refin1090_GPS_Landsat.Rdata")
# # save(varimp-cond_rf22, 
# #      file = "objects/RF/Landsat/rf22_varimp-cond_l1_months_roughvalid-refin1090_GPSdiff_Landsat.Rdata")
# # save(varimp-cond_rf23, 
# #      file = "objects/RF/Landsat/rf23_varimp-cond_l1_months_roughvalid-refin2080_GPS_Landsat.Rdata")
# # save(varimp-cond_rf24, 
# #      file = "objects/RF/Landsat/rf24_varimp-cond_l1_months_roughvalid-refin2080_GPSdiff_Landsat.Rdata")
```
...
```{r}
# save(roc_data1, 
#      file = "objects/RF/Landsat/rf1_rocdata_l1_slope_novalid_GPS_Landsat.Rdata")
# save(roc_data2,
#      file = "objects/RF/Landsat/rf2_rocdata_l1_slope_novalid_GPSdiff_Landsat.Rdata")
# save(roc_data3,
#      file = "objects/RF/Landsat/rf3_rocdata_l1_slope_roughvalid_GPS_Landsat.Rdata")
# save(roc_data4,
#      file = "objects/RF/Landsat/rf4_rocdata_l1_slope_roughvalid_GPSdiff_Landsat.Rdata")
# # save(roc_data5, 
# #      file = "objects/RF/Landsat/rf5_rocdata_l1_slope_roughvalid-refin1090_GPS_Landsat.Rdata")
# # save(roc_data6, 
# #      file = "objects/RF/Landsat/rf6_rocdata_l1_slope_roughvalid-refin1090_GPSdiff_Landsat.Rdata")
# # save(roc_data7,
# #      file = "objects/RF/Landsat/rf7_rocdata_l1_slope_roughvalid-refin2080_GPS_Landsat.Rdata")
# # save(roc_data8, 
# #      file = "objects/RF/Landsat/rf8_rocdata_l1_slope_roughvalid-refin2080_GPSdiff_Landsat.Rdata")
# save(roc_data9,
#      file = "objects/RF/Landsat/rf9_rocdata_l1_threshold_novalid_GPS_Landsat.Rdata")
# save(roc_data10,
#      file = "objects/RF/Landsat/rf10_rocdata_l1_threshold_novalid_GPSdiff_Landsat.Rdata")
# save(roc_data11, 
#      file = "objects/RF/Landsat/rf11_rocdata_l1_threshold_roughvalid_GPS_Landsat.Rdata")
# save(roc_data12, 
#      file = "objects/RF/Landsat/rf12_rocdata_l1_threshold_roughvalid_GPSdiff_Landsat.Rdata")
# # save(roc_data13, 
# #      file = "objects/RF/Landsat/rf13_rocdata_l1_threshold_roughvalid-refin1090_GPS_Landsat.Rdata")
# # save(roc_data14, 
# #      file = "objects/RF/Landsat/rf14_rocdata_l1_threshold_roughvalid-refin1090_GPSdiff_Landsat.Rdata")
# # save(roc_data15,
# #      file = "objects/RF/Landsat/rf15_rocdata_l1_threshold_roughvalid-refin2080_GPS_Landsat.Rdata")
# # save(roc_data16, 
# #      file = "objects/RF/Landsat/rf16_rocdata_l1_threshold_roughvalid-refin2080_GPSdiff_Landsat.Rdata")
# save(roc_data17, 
#      file = "objects/RF/Landsat/rf17_rocdata_l1_months_novalid_GPS_Landsat.Rdata")
# save(roc_data18, 
#      file = "objects/RF/Landsat/rf18_rocdata_l1_months_novalid_GPSdiff_Landsat.Rdata")
save(roc_data19, 
     file = "objects/RF/Landsat/rf19_rocdata_l1_months_roughvalid_GPS_Landsat.Rdata")
# save(roc_data20, 
#      file = "objects/RF/Landsat/rf20_rocdata_l1_months_roughvalid_GPSdiff_Landsat.Rdata")
# # save(roc_data21,
# #      file = "objects/RF/Landsat/rf21_rocdata_l1_months_roughvalid-refin1090_GPS_Landsat.Rdata")
# # save(roc_data22, 
# #      file = "objects/RF/Landsat/rf22_rocdata_l1_months_roughvalid-refin1090_GPSdiff_Landsat.Rdata")
# # save(roc_data23, 
# #      file = "objects/RF/Landsat/rf23_rocdata_l1_months_roughvalid-refin2080_GPS_Landsat.Rdata")
# # save(roc_data24, 
# #      file = "objects/RF/Landsat/rf24_rocdata_l1_months_roughvalid-refin2080_GPSdiff_Landsat.Rdata")
```
